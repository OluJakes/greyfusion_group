    ...
    <section className="relative overflow-hidden bg-graphite text-white">
      ...
      <div className="container-gf relative flex min-h-[92svh] flex-col justify-center py-32">
        ...
        <motion.h1
          ...
          className="mt-5 max-w-4xl font-display text-[clamp(2.25rem,6vw,4.5rem)] font-semibold leading-[1.04] tracking-[-0.02em]"
        >
          {title} <br />
        ...
        >
          <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.97 }}>
            <Link href="#divisions" className="btn-primary text-[15px] px-7 py-3.5">
              Explore Our Divisions
            </Link>
          </motion.div>
          <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.97 }}>
            <Link href="/contact" className="btn-ghost-dark backdrop-blur-sm text-[15px] px-6 py-3.5">
              Start a Project
            </Link>
          </motion.div>
        </motion.div>
